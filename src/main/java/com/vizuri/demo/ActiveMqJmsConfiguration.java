...
public class ActiveMqJmsConfiguration {
    ...
    static PooledConnectionFactory pooledJmsConnectionFactory(ActiveMQProperties properties,
                                                              @Value("${spring.application.name}") String appName,
                                                              @Value("${CLOUD_APP_INSTANCE_NAME}") String cloudAppInstanceName,
                                                              @Value("${mq.initial.redelivery.delay}") int initialRedeliveryDelay,
                                                              @Value("${mq.backff.multiplier}") int backoffMultiplier,
    ...
    static JmsTemplate jmsTopicTemplate(@Qualifier("demoApiPooledJmsConnectionFactory") PooledConnectionFactory pooledJmsConnectionFactory) {
    ...
    static JmsTemplate jmsQueueTemplate(@Qualifier("demoApiPooledJmsConnectionFactory") PooledConnectionFactory pooledJmsConnectionFactory) {
